...
const handleSavePermissions = async () => {
  ...
  setFormLoading(true);
  try {
    await axiosInstance.put(`/roles/${selectedRole._id}`, { permissions: selectedPermissions });
...
const displayPermissions = availablePermissions.length > 0 ? availablePermissions : permissionCategories;
            ...
            {filteredRoles.map(role => (
              <div key={role._id} className="bg-white rounded-lg border border-gray-200 p-4 hover:border-purple-300 hover:shadow-md transition-all group">
                ...
                <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                  <span className="text-[11px] text-gray-600">{role.permissionsCount || 0} permissions</span>
                  <button
