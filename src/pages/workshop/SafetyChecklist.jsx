...
const initialChecklist = [
  { id: 1, name: 'PPE Availability Check (Goggles/Shoes/Aprons)', category: 'Safety Wear', lastInspected: '2024-02-14', status: 'Passed' },
  { id: 2, name: 'Machine Safety Guards & Shields In Place', category: 'Machinery Safety', lastInspected: '2024-02-14', status: 'Passed' },
  { id: 3, name: 'Emergency Stop Switch Functionality Test', category: 'Electrical Safety', lastInspected: '2024-02-10', status: 'Requires Attention' },
  { id: 4, name: 'Fire Extinguisher Pressure & Location Check', category: 'Fire Safety', lastInspected: '2024-02-12', status: 'Passed' },
  { id: 5, name: 'First Aid Kit Supply Restocking', category: 'Medical', lastInspected: '2024-02-15', status: 'Passed' },
];
...
const SafetyChecklist = () => {
  ...
  const handleSaveLogs = () => {
    toast.success('Workshop safety checklist audit report logged successfully!');
  };
