...
const PlacementReports = () => {
  const [reportType, setReportType] = useState('Department-wise Placement');
  ...
  const monthlyGrowthOptions = {
    ...
    yAxis: { title: { text: '' } },
    series: [
      { name: 'Offers Received', data: [15, 32, 54, 76, 88, 96], color: 'var(--color-primary)', fillOpacity: 0.1 }
    ],
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm flex flex-col h-full font-['Inter']">
      ...
      <div className="p-6 border-b border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="text-[16px] font-bold text-gray-800">Placement Audits & Reports</h2>
          <p className="text-[12px] text-gray-500 mt-0.5 font-medium font-semibold">Generate package structures, average salary rates, and unplaced student listings</p>
        </div>
      ...
      <div className="p-6 space-y-6 flex-1 overflow-y-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-green-50/50 border border-green-100 rounded-xl p-5 flex items-center justify-between">
            <div className="space-y-1">
              <span className="text-[12px] text-gray-500 font-medium font-semibold uppercase tracking-wider">Highest Package Offered</span>
              <h4 className="text-[20px] font-bold text-green-700">₹18.5 LPA</h4>
            </div>
          ...
          <div className="bg-blue-50/50 border border-blue-100 rounded-xl p-5 flex items-center justify-between">
            <div className="space-y-1">
              <span className="text-[12px] text-gray-500 font-medium font-semibold uppercase tracking-wider">Average Package</span>
              <h4 className="text-[20px] font-bold text-blue-700">₹5.2 LPA</h4>
            </div>
          ...
          <div className="bg-red-50/50 border border-red-100 rounded-xl p-5 flex items-center justify-between">
            <div className="space-y-1">
              <span className="text-[12px] text-gray-500 font-medium font-semibold uppercase tracking-wider">Unplaced Ratio</span>
              <h4 className="text-[20px] font-bold text-red-700">12.5%</h4>
            </div>
        ...
        <div className="bg-gray-50/40 p-4 border border-gray-100 rounded-xl">
          <h4 className="font-bold text-gray-800 text-[14px] mb-4 font-semibold uppercase tracking-wider">Recruitment Offers Growth Analysis</h4>
          <HCReact highcharts={Highcharts} options={monthlyGrowthOptions} />
        </div>
      </div>
    </div>
  );
