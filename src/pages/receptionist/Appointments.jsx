          ...
          <tbody>
            {filtered.map(item => (
              <tr key={item.id} className="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                ...
                <td className="py-4 px-6 text-[13px] text-primary font-semibold">{item.host}</td>
                ...
                <td className="py-4 px-6">
                  {item.status === 'Pending Approval' ? (
                    <button onClick={() => handleApprove(item.id)} className="px-2.5 py-1 text-[11px] font-bold bg-primary text-white rounded hover:bg-primary-hover">Approve</button>
                  ) : (
